...
export const CUSTOMERS: Customer[] = [
  ...
  // ★ ADR-B3 デモ世帯: 複数商品・一部商品のみ契約予定日未入力で ⚠️ が出る理想形
  {
    id: "c_demo1",
    name: "松本 健司",
    type: "individual",
    area: "袋井",
    primaryUserId: "u1",
    headPersonId: "p_demo1_head",
    familyMemo: "家族: 配偶者、子1名",
    tags: ["生命保険", "医療保険", "自動車"],
    memo: "ADR-B3デモ: 複数商品・進捗不揃い",
    tasks: [],
    status: "active",
    lastContactDate: d(3),
  },
...
export const NOTIFICATIONS: Notification[] = [
  {
    ...
    type: "comment",
    title: "コメントが付きました",
    body: "佐藤 健一さんからコメントが付きました",
    isRead: false,
    relatedReportId: `r_${d(1)}_u1`,
    createdAt: `${d(1)}T19:30:00`,
  },
  {
    id: "n2",
    userId: "u1",
  ...
  },
  {
    ...
    type: "confirmed",
    title: "日報が確認済みになりました",
    body: `${d(2)}の日報が確認済みになりました`,
    isRead: true,
    relatedReportId: `r_${d(2)}_u1`,
    createdAt: `${d(2)}T19:30:00`,
  },
  {
    id: "n4",
    userId: "u1",
    type: "sent_back",
    title: "日報が差し戻されました",
    body: `${d(5)}の日報が差し戻されました`,
    isRead: true,
    relatedReportId: `r_${d(5)}_u1`,
    createdAt: `${d(5)}T20:00:00`,
  },
];
...
export const AUDIT_LOGS: AuditLog[] = [
  {
    ...
    result: "success",
    diff: { status: { before: "planning", after: "submitted" } },
    createdAt: `${d(1)}T18:30:00`,
  },
  {
    id: "al2",
    userId: "u1",
  ...
  },
  {
    ...
    userAgent: "Chrome/125",
    result: "success",
    diff: { role: { before: "general", after: "manager" } },
  ...
  },
  {
    ...
    result: "success",
    diff: { status: { before: "submitted", after: "confirmed" } },
    createdAt: `${d(2)}T19:30:00`,
  },
  {
    id: "al5",
...
export const TASK_TEMPLATES: TaskTemplate[] = [
  ...
  // ── ステージ到達（stage_reached / proposal）──────────────────────────────
  {
    ...
    triggerStage: "proposal" as import("../types").OpportunityStage,
    productCategories: null,
    defaultDueOffsetDays: 5,
    defaultPriority: "high" as TaskPriority,
    order: 10,
  ...
  // ── ステージ到達（stage_reached / issued）──────────────────────────────
  {
    ...
    scope: "opportunity",
    trigger: "stage_reached",
    triggerStage: "issued" as import("../types").OpportunityStage,
    productCategories: null,
